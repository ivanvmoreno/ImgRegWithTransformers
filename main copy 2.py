...
def run(ids_to_process=None):
    ...
    for current_id in ids:
        ...
        transformed_target = utils.warp_tensor(
            target, displacement_field, device=device
        )
        ...
        del source, target, source_landmarks, target_landmarks
        if load_masks:
